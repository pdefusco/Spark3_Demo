...
```
DROP TAG
spark.sql("ALTER TABLE SPARK_CATALOG.DEFAULT.ICEBERG_CELL_TOWERS DROP TAG businessOrg").show()
```

```
# DROP TABLES
spark.sql("DROP TABLE IF EXISTS SPARK_CATALOG.DEFAULT.ICEBERG_CELL_TOWERS PURGE")
```
